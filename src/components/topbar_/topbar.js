...
import {Box, Home, MapPinHouse, Search, Shapes, UserCircle2} from 'lucide-react';
...
export default function Topbar_() {
    const { device, set_dynamics_portal_main, dynamic_portal_ab, set_dynamics_portal_ab, cart_ } = useContext(dynamic_);
                        ...
                        r={
                            <>
                                ...
                                <div className="df aic gap05 wfp">
                                    ...
                                    <span className="df aic fx1 oh font-sm gap02  bdrds bd" style={{ color: 'black' }}>
