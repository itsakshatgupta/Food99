                ...
                <div className="hfp df fd-c xbg">
                    ...
                    <div className="df fd-c pd08 xbg">
                        ...
                        <Link href='/account/address_book' className="__menu_items mg0 bdb gap03 font500 pdy1"><LucideMapPinHouse />
                            <div className="df fd-c gap2 fx1"><span className="font600 pdx02 pdy02">Address Book</span><div><div className="font08 pdb1"><span className="pdx05 pdy02" style={{
                                background: 'whitesmoke',
                                color: '#673AB7',
                                fontSize: '0.775rem !important'
                            }}><b>Home:</b> Manduadhi varanasi</span></div><span className="font08">Manage your Multiple Devilery Address</span></div>
                            </div>
                            <ChevronRight />
                        </Link>
