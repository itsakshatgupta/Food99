    ...
    return (<>
        ...
        {device === 'mobile' && menu___i ?
            <>
                ...
                <div className={`${isScrolled && "xbg_ bdBrds bdb pdb01"} topbar-container pS`} style={{ top: 0, zIndex: 2, backdropFilter: 'blur(1px)', background: isScrolled?'ghostwhite':'transparent', borderColor:'#8ab3ffff', transition:'all 0.3s ease', boxShadow:isScrolled&&'0 1px 5px 1px #d8d8d8ff' }} ref={top_header}>
                    <Topbar_ />
                </div>
                ...
                <div className='df fd-c xbg pR bdTrds bdt' style={{ zIndex: 1, boxShadow: '0 0 12px 1px #323232' }}>
                    ...
                    <div className="df aic jcsb bdb pdx1 pdt08 pdb06 ybg gap3 ox pS " style={{
                        ...
                        <div className="df aic gap1 fx1">
                            <span className="df aic gap02 font08 pdx05 pdy04 bd bdrds" style={{ background: '#5f54f8ff', color: 'white', border: '1px solid black' }}>
