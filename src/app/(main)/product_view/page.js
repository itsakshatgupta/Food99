    ...
    return (
        <>
            ...
            <div className="max-w-6xl mx-auto px-4 py-6">
                ...
                {/* Grid: Media | Info */}
                <div className="df jcsb text-xs mgy03">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <div className="mt-4 flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
                            ...
                            <div className="w-full sm:w-auto flex gap-3 items-center jcsb">
                                ...
                                <button
                                    className="md:inline-flex items-center gap-2 px-3 py-2 border rounded-md"
                        ...
                        <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            {/* <div>
                                <h3 className="font-semibold mb-2 dn">Seller</h3>
                                <div className="text-sm text-gray-700">
                                    <div className="font-medium">{product.seller.name} {product.seller.verified && <span className="text-emerald-600">• Verified</span>}</div>
                                    <div>{product.seller.city}</div>
